...
public class Chatgpt4Rest {
    ...
    @PutMapping("/chats/{id}")
    public Mono<ResponseEntity<Chat>> updateChat(@PathVariable String id, @RequestBody ApiRequestDto request) {
    ...
    public Mono<ResponseEntity<Void>> deleteChat(@PathVariable String id) {
